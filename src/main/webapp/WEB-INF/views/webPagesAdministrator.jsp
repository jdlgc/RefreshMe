...
<%-- 		<jsp:useBean id="estePartido" class="com.upm.refreshme.backend.WebPage"  /> --%>
<%-- 		<jsp:setProperty name="estePartido" property="url" value="1X2" /> --%>
...
<%--                     <%ArrayList<WebPage> data = (ArrayList<WebPage>)request.getAttribute("data"); --%>
                    <%ArrayList<WebPage> data = new ArrayList<WebPage>();
                    WebPage w = new WebPage("Web1", "www.web1.com", "", "");
                    data.add(0, w);
                         for(WebPage wp:data){%> 
                    <tr>
                        <td><%=wp.getNombre()%></td>
